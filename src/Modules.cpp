...
CModule::EModRet CModule::OnServerNotice(CNick& Nick, CString& sMessage) { return CONTINUE; }
...
bool CModules::OnServerNotice(CNick& Nick, CString& sMessage) { MODHALTCHK(OnServerNotice(Nick, sMessage)); }
